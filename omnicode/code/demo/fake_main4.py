	...
	try:
		try:
			...
			def fake_scan():
				...
				qrData = "CLIENT=SAMSUNG,PROJECT=123456,STAGE=INSP,BOARDS=500,PANELS=30,STAFF_ID=456,TIME=00:00,DATE=01-01-2000,START=00:00,STOP=00:00,REASON=NULL,SERIAL=123456789"
