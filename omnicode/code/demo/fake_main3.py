	...
	try:
		try:
			...
			def fake_scan():
				...
				qrData = "CLIENT=TSE,PROJECT=369852,STAGE=SMT,BOARDS=1000,PANELS=50,STAFF_ID=357,TIME=00:00,DATE=01-01-2000,START=00:00,STOP=00:00,REASON=NULL,SERIAL=369852147"
